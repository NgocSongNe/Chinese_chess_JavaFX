...
public class MainFrame extends JFrame {
	...
	private JPanel getJContentPane() {
		...
		jLabel = new JLabel();
		jLabel.setIcon(new ImageIcon("chess/chinese_chess/images/main.gif"));
...
//Exit button	
	...
	public void newGame(){
		...
		String[] str = readImageFolder("chess/chinese_chess/images");//read the image into the chessBoard
	...
	public static String[] readImageFolder(String url){
		...
		if(!f.exists()|| !f.isDirectory()){
			System.out.println("Vui lòng nhập tên thư mục hợp lệ!");
			return null;
		}
